...
const NoData = ({ title }) => {
  return (
    ...
    <div className="flex flex-col items-center justify-center w-full min-h-[50vh] py-12 px-4 bg-white rounded-xl border border-gray-300 shadow-2xl transition duration-300 ease-in-out hover:shadow-gray-400/50">
